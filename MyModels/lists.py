'''This list is to choose gender/sex.'''
sex = (('1', 'Female'), ('2', 'Man'))

'''This is list to chooce degre.'''
listOfDegree = (('1', 'Bachelor'),
                ('2', 'Master'),
                ('3', 'Doctorate'))

'''This list is to chooce day.'''
listOfDays = (('1', 'Monday'),
              ('2', 'Tuesday'),
              ('3', 'Wednesday'),
              ('4', 'Thursday'),
...
'''This list is to choose semester.'''
listOfSemesters = (('1', 'Summer'),
                   ('2', 'Winter'),
                   ('3', 'Spring'))

'''This list is to choose slot.'''
listOfSlots = (('1', '17-18'),
               ('2', '18-19'),
               ('3', '19-20'),
               ('4', '20-21'),
...
'''This list is to choose place.'''
listOfPlaces = (('1', '101'),
                ('2', '102'),
                ('3', '103'))

'''This list is to choose sector.'''
listOfSectors = (('1', 'Education'),
                 ('2', 'Health'))
